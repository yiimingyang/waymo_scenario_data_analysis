...
def find_preceeding_following_in_left_lane(scenario, 
    ...
    if len(left_neighbors_id_list) == 0:
        ...
        for left_lane_id in left_neighbors_id_list:
            ...
            b2 = None
            c2 = None
            if number_of_points_in_left_lane > 100: # 0.5m between two map points, equal to 50m
                first_point_index = 0
                last_point_index = number_of_points_in_left_lane - 1
                first_point_x = left_lane.point_x_list[first_point_index]
                first_point_y = left_lane.point_y_list[first_point_index]
                last_point_x  = left_lane.point_x_list[last_point_index]
                last_point_y  = left_lane.point_y_list[last_point_index]
                
                middle_point_index = int(0.5 * (number_of_points_in_left_lane - 1))
                middle_point_x  = left_lane.point_x_list[middle_point_index]
                middle_point_y  = left_lane.point_y_list[middle_point_index]
            ...
            for surrounding_vehicle in scenario.agents_list:    
                ...
                if a1 == None:
                    ...
                    #print("split the left lane into two")
                ...
                if distance < 1.0:
                    if abs(first_point_x - last_point_x) >= abs(first_point_y - last_point_y):
                        if is_in_range(first_point_x, last_point_x, surrounding_vehicle_state_x):
                            print(" --- surround left vehicle id is : ", surrounding_vehicle_id)
                            print(" --- surround vehicle distance from left lane: ", left_lane_id, " is : ", distance)  
...
def find_preceeding_following_in_right_lane(scenario, 
    ...
    if len(right_neighbors_id_list) == 0:
        ...
        for right_lane_id in right_neighbors_id_list:
            ...
            #print("number of points in this lane is : ",number_of_points_in_right_lane)
            ...
            b2 = None
            c2 = None
            if number_of_points_in_right_lane > 100: # 0.5m between two map points, equal to 50m
                first_point_index = 0
                last_point_index = number_of_points_in_right_lane - 1
                first_point_x = right_lane.point_x_list[first_point_index]
                first_point_y = right_lane.point_y_list[first_point_index]
                last_point_x  = right_lane.point_x_list[last_point_index]
                last_point_y  = right_lane.point_y_list[last_point_index]
                
                middle_point_index = int(0.5 * (number_of_points_in_right_lane - 1))
                middle_point_x  = right_lane.point_x_list[middle_point_index]
                middle_point_y  = right_lane.point_y_list[middle_point_index]
            ...
            for surrounding_vehicle in scenario.agents_list:    
                ...
                if a1 == None:
                    ...
                    #print("split the right lane into two")
                    distance1 = calculate_distance_from_line(a1, b1, c1, surrounding_vehicle_state_x, surrounding_vehicle_state_y)
                    distance2 = calculate_distance_from_line(a2, b2, c2, surrounding_vehicle_state_x, surrounding_vehicle_state_y)
                    distance = distance1 if distance1 <= distance2 else distance2
                if distance < 1.0:
                    if abs(first_point_x - last_point_x) >= abs(first_point_y - last_point_y):
                        if is_in_range(first_point_x, last_point_x, surrounding_vehicle_state_x):
                            print(" --- surround right vehicle id is : ", surrounding_vehicle_id)
                            print(" --- surround vehicle distance from right lane: ", right_lane_id, " is : ", distance)  
                            #print(" --- lane x1 is : ", first_point_x)
                            #print(" --- lane x2 is : ", last_point_x)
