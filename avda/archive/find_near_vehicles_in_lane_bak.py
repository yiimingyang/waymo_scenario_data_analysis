...
def find_preceeding_following_in_lane(scenario, 
    ...
    number_of_points_in_this_lane = len(ego_lane.points_list)
    first_point_index = 0
    ...
    for surrounding_vehicle in scenario.agents_list:    
        ...
        #print("surrounding vehicle id is :", surrounding_vehicle_id)
        #print("surrounding vehicle distance is :", distance)
        if distance < 2:
